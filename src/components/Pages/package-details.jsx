...
export function PackageDetails() {
  return (
    <div className="min-h-screen z-10 relative flex flex-col">
      ...
      {/* Cards Container */}
      <div className="bg-[#161E22] md:flex flex-wrap space-y-12 md:space-y-0 md:space-x-6 z-20 justify-evenly md:max-h-[500px] text-white px-4 py-10">
        {[...Array(4)].map((_, index) => (
          <div
            key={index}
            className="flex flex-col shadow-xl shadow-black rounded-xl w-full sm:w-[20vw] max-h-[360px] p-6 bg-[#1E2A30]"
          >
            <div className="pb-7">
              <svg
                className="mx-auto"
